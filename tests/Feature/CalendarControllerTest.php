...
test('index redirects when year and month are missing', function () {
    $now = Carbon::now();
...
test('index shows calendar with valid year and month', function () {
    $response = $this->get(route('calendar.index', [
        'year' => $this->year,
        'month' => $this->month
    ]));
...
test('create returns 404 for invalid date', function () {
...
test('create shows form with valid date', function () {
    $response = $this->get(route('calendar.create', [
        'year' => $this->year,
        'month' => $this->month,
        'day' => $this->day
...
test('store returns 404 for invalid date', function () {
...
test('store prevents duplicate module for vehicle', function () {
    // Setup
    ...
    // Try to create another planning with the same module and vehicle
    $response = $this->post(route('calendar.store', [
        'year' => $this->year,
        'month' => $this->month,
        'day' => $this->day
